...
namespace PowerPath.Web.Migrations
{
    ...
    [Migration("20250429104519_CreateProgressRecordEntity")]
    partial class CreateProgressRecordEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PowerPath.Web.Data.Entities.CompletedSet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PowerPath.Web.Data.Entities.ExerciseType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PowerPath.Web.Data.Entities.ProgrammedSet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PowerPath.Web.Data.Entities.ProgressRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PowerPath.Web.Data.Entities.TrainingCycle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PowerPath.Web.Data.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PowerPath.Web.Data.Entities.UserMax", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PowerPath.Web.Data.Entities.WorkoutDay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PowerPath.Web.Data.Entities.WorkoutWeek", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("PowerPath.Web.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PowerPath.Web.Data.Entities.CompletedSet", b =>
                {
                    b.HasOne("PowerPath.Web.Data.Entities.ProgrammedSet", "ProgrammedSet")
                        .WithMany()
            ...
            modelBuilder.Entity("PowerPath.Web.Data.Entities.ProgrammedSet", b =>
                {
                    b.HasOne("PowerPath.Web.Data.Entities.ExerciseType", "ExerciseType")
                        .WithMany()
                    ...
                    b.HasOne("PowerPath.Web.Data.Entities.WorkoutDay", "WorkoutDay")
                        .WithMany()
            ...
            modelBuilder.Entity("PowerPath.Web.Data.Entities.ProgressRecord", b =>
                {
                    ...
                    b.HasOne("PowerPath.Web.Data.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("PowerPath.Web.Data.Entities.UserMax", b =>
                {
                    ...
                    b.HasOne("PowerPath.Web.Data.Entities.TrainingCycle", "TrainingCycle")
                        .WithMany()
            ...
            modelBuilder.Entity("PowerPath.Web.Data.Entities.WorkoutDay", b =>
                {
                    ...
                    b.HasOne("PowerPath.Web.Data.Entities.WorkoutWeek", "WorkoutWeek")
                        .WithMany()
